/**
 * @file LlmService.js
 * @description Simulates an external LLM (Large Language Model) API call
 * with a significant, non-blocking delay (10-20 seconds).
 */

class LlmService {
    /**
     * @method getSimulatedResponse
     * @param {string} userMessage - The message sent by the user (unused in simulation, but kept for abstraction)
     * @returns {Promise<object>} A promise that resolves with the simulated AI response after a delay.
     */

...
import { Gem, LogIn, Mail, Lock, Chrome, Apple } from "lucide-react"; // Added Chrome and Apple
            ...
            <div className="w-full max-w-sm space-y-6 p-8 bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 transition duration-300 hover:shadow-gray-700/50">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full flex justify-center items-center space-x-2 py-3 px-4 border border-transparent rounded-lg shadow-lg text-base font-semibold text-black bg-whaite hover:bg-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 disabled:opacity-50 transition duration-150 ease-in-out"
                    >
                        {loading ? (
                            <>

...
export default function LoginPage() {
    ...
    return (
        ...
        <div className="min-h-screen flex items-center justify-center p-4 md:p-10 bg-black text-white font-inter">
            <div className="w-full max-w-sm space-y-6 p-8 bg-gray-950 rounded-2xl shadow-2xl border border-gray-700 transition duration-300 hover:shadow-gray-700/50">

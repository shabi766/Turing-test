...
export default function LoginPage() {
    ...
    return (
        ...
        <div className="min-h-screen flex items-center justify-center p-4 md:p-10 bg-gray-950 text-white font-inter">
            <div className="w-full max-w-sm space-y-6 p-8 bg-gray-950 rounded-2xl shadow-2xl border border-b-gray-200 transition duration-300 hover:shadow-gray-700/50">
                ...
                <div className="flex flex-col items-center space-y-2">
                    ...
                    <p className="text-whiate text-sm">Sign in to start chatting with the LLM simulation.</p>
                </div>

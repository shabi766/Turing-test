...
// Assuming context and API imports are correctly set up
// We use the direct API call for registration, then redirect to login.
...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. Notify and redirect to login
    ...
    // Handler for simulated social sign-up buttons
        ...
        <div className="min-h-screen flex items-center justify-center p-4 md:p-10 bg-gray-900 text-white font-inter">
            <div className="w-full max-w-sm space-y-6 p-8 bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 transition duration-300 hover:shadow-gray-700/50">
                ...
                <div className="flex flex-col items-center space-y-2">
                    <div className="flex items-center space-x-3 text-3xl font-bold text-green-400">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full flex justify-center items-center space-x-2 py-3 px-4 border border-transparent rounded-lg shadow-lg text-base font-semibold text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 disabled:opacity-50 transition duration-150 ease-in-out"
                    >
                        {loading ? (
                            <>
